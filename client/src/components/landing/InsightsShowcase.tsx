...
export const InsightsShowcase: React.FC = () => {
  const kpis = [
    { label: 'SALES IN PROGRESS', value: '₹46.0L', change: '+14.2%', icon: TrendingUp, positive: true },
    { label: 'ACTIVE DEALS', value: '25 DEALS', change: '+5 new', icon: Target, positive: true },
    { label: 'WIN RATE', value: '68.4%', change: '+3.1%', icon: BarChart2, positive: true },
    { label: 'TASKS FINISHED', value: '142', change: '98% on time', icon: CheckCircle, positive: true }
  ];
    ...
    <section id="insights" className="py-20 px-4 sm:px-6 border-b border-vynexa-border bg-vynexa-surface/30">
      <div className="mx-auto max-w-7xl space-y-12">
        <div className="text-center max-w-2xl mx-auto space-y-2">
          <h2 className="text-xs font-mono font-semibold tracking-wider text-vynexa-text-muted uppercase">REPORTS &amp; RESULTS</h2>
          <p className="text-2xl sm:text-3xl font-bold text-vynexa-text-primary tracking-tight">
            See how your sales and team are performing
          </p>
          <p className="text-xs sm:text-sm text-vynexa-text-secondary">
            Clear numbers on deals in progress, completed tasks, and monthly revenue so you always know how your business is doing.
          </p>
        </div>
        ...
        <div className="rounded-xl border border-vynexa-border bg-vynexa-surface p-6 shadow-elevated space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-vynexa-border pb-4">
            <div>
              <h3 className="text-sm font-semibold text-vynexa-text-primary tracking-tight">Monthly Sales Performance</h3>
              <p className="text-xs text-vynexa-text-muted">From new leads to signed orders</p>
            </div>
